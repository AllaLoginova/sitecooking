"""
Django settings for sitecooking project.
...
from django.conf.global_settings import STATICFILES_DIRS, MEDIA_ROOT, MEDIA_URL, LOGIN_REDIRECT_URL, \
    LOGOUT_REDIRECT_URL, LOGIN_URL, ALLOWED_HOSTS, STATIC_ROOT
...
WSGI_APPLICATION = 'sitecooking.wsgi.application'
